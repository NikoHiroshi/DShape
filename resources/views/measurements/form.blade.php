          ...
          <div class="card-body">
            <div class="container px-3 my-3">
              <form action="/measurements/new" method="POST">
                ...
                {{-- Botões --}}
                <div class="d-flex ">
                  <button class="btn btn-success btn-lg flex-fill me-1" id="submitButton" type="submit">Enviar</button>
                  <button class="btn btn-danger btn-lg flex-fill ms-1" type="reset">Limpar</button>
                </div>
              </form>
            </div>
